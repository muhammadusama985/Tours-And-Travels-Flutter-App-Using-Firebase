...
class NewUploadRideData extends StatefulWidget {
  const NewUploadRideData({
    super.key,
  });

  @override
  _NewUploadRideDataState createState() => _NewUploadRideDataState();
}

class _NewUploadRideDataState extends State<NewUploadRideData> {
  File? _carImage;
  File? _userImage;
