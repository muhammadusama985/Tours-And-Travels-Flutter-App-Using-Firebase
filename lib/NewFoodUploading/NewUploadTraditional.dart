...
class NewUploadTraditionalFood extends StatefulWidget {
  const NewUploadTraditionalFood({
    super.key,
  });

  @override
  _NewUploadTraditionalFoodState createState() =>
      _NewUploadTraditionalFoodState();
}

class _NewUploadTraditionalFoodState extends State<NewUploadTraditionalFood> {
  File? _foodImage;
  File? _userImage;
  ...
  Future<void> _uploadData() async {
    ...
    await FirebaseFirestore.instance.collection('Traditional').add({
