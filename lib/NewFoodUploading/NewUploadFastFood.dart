...
class NewUploadFastFood extends StatefulWidget {
  const NewUploadFastFood({
    super.key,
  });

  @override
  _NewUploadFastFoodState createState() => _NewUploadFastFoodState();
}

class _NewUploadFastFoodState extends State<NewUploadFastFood> {
  File? _foodImage;
  File? _userImage;
  ...
  Future<void> _uploadData() async {
    ...
    await FirebaseFirestore.instance.collection('Fast').add({
