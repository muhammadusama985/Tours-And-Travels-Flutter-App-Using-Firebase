...
class NewUploadChineseFood extends StatefulWidget {
  const NewUploadChineseFood({
    super.key,
  });

  @override
  _NewUploadChineseFoodState createState() => _NewUploadChineseFoodState();
}

class _NewUploadChineseFoodState extends State<NewUploadChineseFood> {
  File? _foodImage;
  File? _userImage;
  ...
  Future<void> _uploadData() async {
    ...
    await FirebaseFirestore.instance.collection('Chinese').add({
