...
class NewUploadDesiFood extends StatefulWidget {
  const NewUploadDesiFood({
    super.key,
  });

  @override
  _NewUploadDesiFoodState createState() => _NewUploadDesiFoodState();
}

class _NewUploadDesiFoodState extends State<NewUploadDesiFood> {
  File? _foodImage;
  File? _userImage;
  ...
  Future<void> _uploadData() async {
    ...
    await FirebaseFirestore.instance.collection('Desi').add({
