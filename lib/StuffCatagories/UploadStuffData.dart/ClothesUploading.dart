...
class Clothesuploading extends StatefulWidget {
  const Clothesuploading({
    super.key,
  });

  @override
  _ClothesuploadingState createState() => _ClothesuploadingState();
}

class _ClothesuploadingState extends State<Clothesuploading> {
  File? _stuffImage;
  File? _userImage;
