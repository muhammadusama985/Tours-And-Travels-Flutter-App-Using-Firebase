...
class Electronicsuploading extends StatefulWidget {
  const Electronicsuploading({
    super.key,
  });

  @override
  _ElectronicsuploadingState createState() => _ElectronicsuploadingState();
}

class _ElectronicsuploadingState extends State<Electronicsuploading> {
  File? _stuffImage;
  File? _userImage;
