...
class Trackinguploading extends StatefulWidget {
  const Trackinguploading({
    super.key,
  });

  @override
  _TrackinguploadingState createState() => _TrackinguploadingState();
}

class _TrackinguploadingState extends State<Trackinguploading> {
  File? _stuffImage;
  File? _userImage;
