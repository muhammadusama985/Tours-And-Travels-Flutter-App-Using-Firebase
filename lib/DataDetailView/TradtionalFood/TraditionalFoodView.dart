...
class TraditionalFoodView extends StatefulWidget {
  const TraditionalFoodView({super.key});

  @override
  _TraditionalFoodViewState createState() => _TraditionalFoodViewState();
}

class _TraditionalFoodViewState extends State<TraditionalFoodView> {
  ...
  void initState() {
    super.initState();
    _stream = FirebaseFirestore.instance.collection('Traditional').snapshots();
  }
