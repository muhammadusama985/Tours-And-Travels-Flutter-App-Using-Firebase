...
class DesiFoodView extends StatefulWidget {
  const DesiFoodView({super.key});

  @override
  _DesiFoodViewState createState() => _DesiFoodViewState();
}

class _DesiFoodViewState extends State<DesiFoodView> {
  ...
  void initState() {
    super.initState();
    _stream = FirebaseFirestore.instance.collection('Desi').snapshots();
  }
